(function() {
  ...
  function init() {
    //Links
    let anchor1Link  = d.getElementById('tobanner');
    let anchor2Link  = d.getElementById('toplomb');
    let anchor3Link  = d.getElementById('totoit');
    let anchor4Link  = d.getElementById('tozing');
    let anchor5Link  = d.getElementById('tofooter');
    let anchor1Link2  = d.getElementById('tobanner2');
    let anchor2Link2  = d.getElementById('toplomb2');
    let anchor3Link2  = d.getElementById('totoit2');
    let anchor4Link2  = d.getElementById('tozing2');
    let anchor5Link2  = d.getElementById('tofooter2');
    // let anchor5Link3  = d.getElementById('startnow');

    //Anchors
    let anchor1      = d.getElementById('banner');
    let anchor2      = d.getElementById('plomb');
    let anchor3      = d.getElementById('toit');
    let anchor4      = d.getElementById('zing');
